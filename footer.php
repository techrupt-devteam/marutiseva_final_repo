<style type="text/css">
  ...
  <div class="footer-top">
    <div class="container">
      <div class="row">
        <div class="col-md-4 footer-box"> <img src="assets/images/icon/location.svg" width="35"/>
          <div class="footer-box-content">
            <h3>X-46, MIDC,Ambad, Nashik,</h3>
            <p>Maharashtra 422010 <span style="color: #ff0b0b;font-size: 12px;"> (Head Office )</span></p>
          </div>
        </div>
        <!-- Box 1 end-->
        <div class="col-md-4 col-sm-6 footer-box"> <img src="assets/images/icon/phone.svg" width="35"/>
          <div class="footer-box-content">
        ...
        <!-- Box 2 end-->
        <div class="col-md-4 col-sm-6 footer-box"> <img src="assets/images/icon/mail.svg" width="35" style="margin-left: 35px;"/>
          <div class="footer-box-content">
            <h3 class="text-white mt-2">enquiry@marutiseva.com</h3>
            <!-- <p class="text-white">24/7 online support</p> -->
          </div>
        </div>
        <!-- Box 3 end--> 
      </div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4">
              <div class="mainlinks">
                ...
                <ul>
                  ...
                  <li><a href="http://truevalue.marutiseva.com"> True Value Cars </a></li>
                </ul>
              </div>
            </div>
  ...
  $(document).ready(function() {
   ...
   $('.menu li').each(function(){
    ...
    if(url == href){
     ...
     if(parentClass == 'submenu'){    // Add class
