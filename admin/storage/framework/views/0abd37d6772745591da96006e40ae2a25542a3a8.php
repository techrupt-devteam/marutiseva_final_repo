            ...
            <div class="box-header">
              ...
              <div class="row"> 
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo e(url('/admin')); ?>/seva_enq_csv" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
                       <div class="col-md-3">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\marutiseva_final\admin\resources\views/admin/booking/enquiry.blade.php ENDPATH**/ ?>