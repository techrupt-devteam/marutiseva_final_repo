...
<div class="login-box">
  <div class="login-logo">
    <img src="<?php echo e(url('/admin_css_js')); ?>/css_and_js/logo.png">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo e(url('/admin')); ?>/login_process" method="post" data-parsley-validate="parsley">
      ...
      <div class="form-group has-feedback">
        <input type="text" name="email" class="form-control" placeholder="Username"   required="true">
    ...
    <a class="text-red" href="<?php echo e(url('/admin')); ?>/forget_password">I forgot my password</a><br>
...
<?php /**PATH D:\xampp\htdocs\marutiseva_final\admin\resources\views/admin/login.blade.php ENDPATH**/ ?>