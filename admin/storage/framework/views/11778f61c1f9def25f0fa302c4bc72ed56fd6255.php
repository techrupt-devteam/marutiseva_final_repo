      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb pull-right">
            <li class="breadcrumb-item"><a href="<?php echo e(url('/admin')); ?>/dashbord">Home</a></li>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\marutiseva_final\admin\resources\views/admin/dashbord.blade.php ENDPATH**/ ?>