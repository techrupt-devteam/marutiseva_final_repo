            ...
            <form action="{{url('/admin')}}/update_offer/{{$data->id}}" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <input type="text" class="form-control" name="car_maker" value="{{$data->car_maker}}" readonly="">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <img id="output_image1" height="200px" width="220" src="http://marutiseva.com/{{$data->image}}"/>
              ...
              <div class="box-footer">
                <a href="{{url('/admin')}}/nexa_offers" type="submit" class="btn btn-primary pull-right">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
