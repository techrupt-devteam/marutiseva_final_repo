      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{url('/admin')}}/store_offer" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="car_maker" name="car_maker" onchange="function_car()" required="true">
                    ...
                    <option value="{{$value->car_id}}">{{$value->car}}</option>
                    @endforeach
                  </select>
                </div>
                <div class="form-group">
