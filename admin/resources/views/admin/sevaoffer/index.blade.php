        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{url('/admin')}}/add_{{$url_slug}}" class="btn btn-primary btn-sm" style="float: right;">Add Offer Slider</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                  ...
                  @foreach($data as $key=>$value)
                    <tr>
                      ...
                      <td>
                        <form action="{{ url('/admin')}}/update_offerorder_no/{{$value['slider_id']}}" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data"> 
                      ...
                      <td><a href="{{url('/')}}/upload/seva_offer_banner/{{$value['slider_img']}}" data-fancybox="gallery" data-caption="Caption #1"><img src="{{url('/')}}/upload/seva_offer_banner/{{$value['slider_img']}}" width="50" height="50"></a></td>
